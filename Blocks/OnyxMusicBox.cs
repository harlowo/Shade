...
{
    public class OnyxMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Content01/Assets/Music/Experimentation"), ModContent.ItemType<OnyxMusicBox>(), ModContent.TileType<OnyxMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<OnyxMusicBoxTile>(), 0);
        }
    }
}