...
namespace Shade.Common.UI
{
    public class VanillaLifeOverlay : ModResourceOverlay
    {
        ...
        public override void PostDrawResource(ResourceOverlayDrawContext context)
        {
            ...
            int exampleFruits = Main.LocalPlayer.GetModPlayer<OnyxLifePlayer>().LifeCorez;

            // Life resources are drawn over in groups of two
            if (context.resourceNumber >= 20 * exampleFruits)
                return;
        ...
        private void DrawClassicFancyOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = heartTexture ??= ModContent.Request<Texture2D>("Shade/Common/UI/ClassicLifeOverlay");
            context.Draw();
        }
        ...
        private void DrawFancyPanelOverlay(ResourceOverlayDrawContext context)
        {
            ...
            // "context" contains information used to draw the resource
            // If you want to draw directly on top of the vanilla hearts, just replace the texture and have the context draw the new texture
            context.texture = fancyPanelTexture ??= ModContent.Request<Texture2D>("Shade/Common/UI/FancyLifeOverlay_Panel");
        ...
        private void DrawBarsOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = barsFillingTexture ??= ModContent.Request<Texture2D>("Shade/Common/UI/BarsLifeOverlay_Fill");
            context.Draw();
        }
        ...
        private void DrawBarsPanelOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = barsPanelTexture ??= ModContent.Request<Texture2D>("Shade/Common/UI/BarsLifeOverlay_Panel");
