...
namespace Shade
{
    ...
    {
        public static bool downedOnyxBoss = false;
        // public static bool downedOtherBoss = false;

        public override void ClearWorld()
        {
            downedOnyxBoss = false;
        ...
        {
            downedOnyxBoss = tag.ContainsKey("downedOnyxBoss");
